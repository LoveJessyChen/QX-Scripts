...
[rewrite_local]
^https?:\/\/((h5|api)\.xiuxiu|api-sub|api\.posters)\.meitu\.com\/.+\/(vip|user|h\d|center|home) url script-response-body https://raw.githubusercontent.com/LoveJessyChen/QX-Scripts/refs/heads/main/mtxx.js
...
if ($request.url.indexOf(hysj) != -1){
  chxm1023.data = {
    ...
    "pay_interval" : 3000,
    "beautify_prompt" : "",
    "home_prompt" : "会员有效期至9999/09/09",
    "svip_bubble_text" : "粉钻SVIP：有效期至2099/09/09\n粉钻VIP：有效期至9999/09/99",
    "beautify_btn_prompt" : "",
